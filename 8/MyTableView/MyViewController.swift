...
class MyViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        for i in 1...3 {
            let student = Student(stuNo: 20161101 + i, firstName: "彭", lastName: "\(i)", age: 20, gender: .male, department: .one)
            studentArray.append(student)
        }
        
        for i in 1...5 {
            let teacher = Teacher(title: "老师", firstName: "袁", lastName: "\(i)", age: 34, gender: .male, department: .two)
